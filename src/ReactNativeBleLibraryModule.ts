...
import { BleDeviceInfo, ConnectionState, BleServiceInfo, BleServicesInfo, ConnectOptions } from './types'
...
export default requireNativeModule<ReactNativeBleLibraryModule>('ReactNativeBleLibrary')
